...
def main():
    ...
    weights_dir = "freezed_diag_classification.bin"
    state_dict = laplace.laplace_model.state_dict()
    torch.save(state_dict, weights_dir)
    #laplace.load_laplace_model(weights_dir, "classification", "all", "full")
    ...
    for i in range(5):
        ...
        py, images = model(noise, pred_type = "nn", link_approx = "mc", n_samples = 7)
